...
public class Battleship {
    ...
    final static public String[] shipsNames = {"Carrier","Cruiser","Battleship","Destroyer","Submarine"};
...
//////////
    ...
    public static void main(String[]Args){
        ...
        while(player1.remainedShips().length() > 0){
        ...
        boolean valid = false;
            ...
            //After checking the input, place the ship in given coordinates
            player1.placeShip(Ship.findSquares(arr[1],arr[2],arr[3]),arr[0]);
            player1.showMap();

            //show remained ships
            System.out.println("Remained ships: "+player1.remainedShips());
